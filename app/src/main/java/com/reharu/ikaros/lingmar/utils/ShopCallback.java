...
public class ShopCallback extends ItemTouchHelper.SimpleCallback {
    public RecyclerView mRv;
    public List mDatas;
    public RecyclerView.Adapter mAdapter;

    public ShopCallback(RecyclerView rv, RecyclerView.Adapter adapter, List datas) {
        this(0,
                ItemTouchHelper.DOWN | ItemTouchHelper.UP | ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT,
                rv, adapter, datas);
    }

    public ShopCallback(int dragDirs, int swipeDirs
